            ...
            <tr>
              <td style="text-align:center;padding-top:20px;border-top:1px solid rgba(0,0,0,0.08);margin-top:20px;">
                <p style="margin:20px 0 12px;">
                  <a href="https://www.facebook.com/sowvik.karmokersuvo/" style="margin:0 8px;"><img src="https://cdn-icons-png.flaticon.com/32/733/733547.png" width="28" alt="Facebook"></a>
                  <a href="https://www.instagram.com/sowvik_suvo/" style="margin:0 8px;"><img src="https://cdn-icons-png.flaticon.com/32/2111/2111463.png" width="28" alt="Instagram"></a>
                  <a href="https://github.com/SowvikSuvo" style="margin:0 8px;"><img src="https://cdn-icons-png.flaticon.com/32/733/733553.png" width="28" alt="GitHub"></a>
                </p>
...
<body style="margin:0; padding:0; background:radial-gradient(circle at 50% 50%, #162033 0%, #0c0e1a 100%); min-height:100vh; display:flex; align-items:center; justify-content:center; font-family:Arial, Helvetica, sans-serif;">
  ...
  <div style="max-width:620px; width:95%; margin:20px auto; background:rgba(20, 25, 45, 0.65); backdrop-filter:blur(16px); border-radius:24px; padding:44px; border:1px solid rgba(0, 255, 255, 0.2); box-shadow:0 8px 32px rgba(0,0,0,0.6);">
    ...
    <div style="text-align:center; color:#aaa; margin-top:40px;">
      <div style="font-size:20px; font-weight:600; color:#fff;">Suvo Karmoker</div>
      <div style="color:#0ff; font-size:15px;">MERN Stack Web Developer • </div>
    </div>

    <div style="text-align:center; margin:30px 0;">
      <a href="https://www.facebook.com/sowvik.karmokersuvo/" style="margin:0 12px;">
        <img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" width="34" />
      </a>
      <a href="https://www.instagram.com/sowvik_suvo/" style="margin:0 12px;">
        <img src="https://cdn-icons-png.flaticon.com/512/2111/2111463.png" width="34" />
      </a>
      <a href="https://github.com/SowvikSuvo" style="margin:0 12px;">
